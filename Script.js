...
// Create  copy of the original students array to sort
let sortedStudents = [...students];

// Function  render the sorted students array in the table
...
// Event listener for sort  name (ascending) button
...
// Event listener for sort  name (descending) button
...
// Event listener for sort marks button
sortMarksBtn.addEventListener('click', () => {
  sortedStudents.sort((a, b) => b.marks - a.marks);
  renderStudents();
});

// Event listener for sort  passing button
